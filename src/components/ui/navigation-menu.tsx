...
function NavigationMenuViewport({
  ...
  return (
    <div className={cn('absolute top-full right-10 isolate z-50 flex justify-center')}>
      <NavigationMenuPrimitive.Viewport
        data-slot="navigation-menu-viewport"
        className={cn(
          'origin-top-center bg-popover/80 text-popover-foreground ring-foreground/10 data-open:animate-in data-open:zoom-in-90 data-closed:animate-out data-closed:zoom-out-90 relative mt-1.5 h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden rounded-lg shadow ring-1 backdrop-blur-md duration-100 md:w-(--radix-navigation-menu-viewport-width)',
          className,
        )}
        {...props}
      />
