...
const AuraMedicalCTA = () => {
  ...
  return (
    <section className="min-h-body relative w-full overflow-hidden bg-white px-6 py-16">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <motion.div
          ...
          className="bg-secondary/40 border-secondary mb-8 inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs text-[#013a63] lg:px-4 lg:py-2 lg:text-sm"
        >
        ...
        {/* The Typed Headline */}
        <div className="mb-4 flex flex-col items-center justify-center md:min-h-35">
          <h2 className="mb-2 text-3xl font-bold tracking-tight text-[#012a4a] md:text-4xl lg:text-5xl">
            We help you
          </h2>
          <div className="flex items-center justify-center md:h-20">
            <AnimatePresence mode="wait">
              <motion.span
                ...
                className="text-primary text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl"
              >
                {messages[index]}.
              </motion.span>
            </AnimatePresence>
        ...
        <p className="mx-auto mb-8 max-w-2xl text-sm leading-relaxed text-[#012a4a]/70 lg:text-base">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          >
            <Button
              size="default"
              className="bg-primary shadow-primary/20 group h-14 px-8 text-lg text-white shadow-xl transition-all hover:bg-[#013a63]"
            >
          ...
          >
            <Button
              variant="outline"
              size="default"
              className="border-border hover:bg-secondary/20 h-14 bg-white/50 px-8 text-lg text-[#012a4a] backdrop-blur-sm transition-all"
            >
        ...
        <div className="mt-12 flex items-center justify-center gap-8 opacity-50 grayscale transition-all duration-700 hover:grayscale-0">
          ...
          <span className="text-[10px] font-bold tracking-widest text-[#012a4a]">
            ACCREDITED CLINIC
          </span>
          <span className="text-[10px] font-bold tracking-widest text-[#012a4a]">
            ISO 9001 CERTIFIED
