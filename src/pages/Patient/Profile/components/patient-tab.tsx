        ...
        {patients.map((p) => (
          ...
          >
            <CardContent className="p-5">
              ...
              <div className="border-border mt-4 flex flex-wrap items-center justify-between border-t pt-4 text-sm text-[#012a4a]">
                <div className="flex items-center">
                  <Phone className="text-muted-foreground mr-2 h-4 w-4" /> {p.phone}
                </div>
                {(p.heightCm !== undefined || p.weightKg !== undefined) && (
                  <div className="text-muted-foreground flex items-center gap-3 text-xs">
                    {p.heightCm !== undefined && (
                      <span className="flex items-center gap-1">
                        <Ruler className="h-3.5 w-3.5 text-[#014f86]" />
                        <strong className="text-[#012a4a]">{p.heightCm} cm</strong>
                      </span>
                    )}
                    {p.weightKg !== undefined && (
                      <span className="flex items-center gap-1">
                        <Weight className="h-3.5 w-3.5 text-[#014f86]" />
                        <strong className="text-[#012a4a]">{p.weightKg} kg</strong>
                      </span>
                    )}
                  </div>
                )}
