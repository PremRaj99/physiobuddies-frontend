...
interface OnlineNetworkBenefitsProps {
  benefits: BenefitItem[];
  staggerContainer: Variants;
  fadeUpVariant: Variants;
}

export const OnlineNetworkBenefits: React.FC<OnlineNetworkBenefitsProps> = ({
  benefits,
  staggerContainer,
  fadeUpVariant,
}) => {
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-16 text-center">
          <h2 className="text-3xl font-bold text-[#012a4a] md:text-4xl">
            Why Join Our Online Tele-Rehab Network?
          </h2>
          <p className="text-muted-foreground mt-4 text-lg">
            Empowering physiotherapists to deliver world-class digital care without borders.
          </p>
        </div>
