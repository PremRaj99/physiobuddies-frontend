  ...
  return (
    ...
    >
      ...
      <div className="mb-3 flex items-center gap-3">
        ...
        <h3 className="text-sm leading-tight font-bold text-[#012a4a]">{title}</h3>
      </div>

      {/* Description */}
      <p className="text-muted-foreground grow text-xs leading-relaxed">{desc}</p>
...
export default function WhyChooseUs() {
  ...
  return (
    <section className="bg-background px-6 py-8 md:px-12 lg:px-24">
