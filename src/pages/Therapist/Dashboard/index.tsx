              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-[#012a4a]">
                    {TODAY_SESSIONS.filter((s) => s.status !== 'CANCELLED').length}
                  </h3>
                  <p className="text-muted-foreground mt-2 text-xs">
                    {TODAY_SESSIONS.filter((s) => s.status === 'COMPLETED').length} Completed
                  </p>
                </div>
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-[#012a4a]">32</h3>
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-[#012a4a]">₹69,290</h3>
                  <p className="text-muted-foreground mt-2 text-xs">After 18% commission</p>
                </div>
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <h3 className="flex items-baseline gap-1 text-3xl font-bold text-white">
                    4.9 <span className="text-sm font-normal text-[#a9d6e5]">/ 5.0</span>
                  </h3>
                  <div className="mt-2 flex items-center gap-1 text-amber-400">
                    ...
                    <Star className="h-3.5 w-3.5 fill-current" />
                    <Star className="h-3.5 w-3.5 fill-current" />
                    <span className="ml-1 text-[10px] text-gray-300">(48 ratings)</span>
                  </div>
                </div>
            ...
            <Card className="border-border flex h-full flex-col gap-0 bg-white pt-0 shadow-sm">
              ...
              <CardContent className="flex grow flex-col items-center justify-between pt-6">
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie
                        ...
                        stroke="none"
                      >
                        {TREATMENT_MODE_DATA.map((entry, index) => (
                ...
                <div className="mt-4 w-full space-y-2">
                  {TREATMENT_MODE_DATA.map((mode, index) => (
